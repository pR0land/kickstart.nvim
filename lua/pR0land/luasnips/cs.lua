...
return {
  ...
  s('lateupdate', { t 'void LateUpdate() {', t { '', '    ' }, i(1), t { '', '}' } }),
  ...
  s('ontriggerexit', { t 'void OnTriggerExit(Collider other) {', t { '', '    ' }, i(1), t { '', '}' } }),
  s('ontriggerstay', { t 'void OnTriggerStay(Collider other) {', t { '', '    ' }, i(1), t { '', '}' } }),
  s('oncollisionenter', { t 'void OnCollisionEnter(Collision collision) {', t { '', '    ' }, i(1), t { '', '}' } }),
  s('oncollisionexit', { t 'void OnCollisionExit(Collision collision) {', t { '', '    ' }, i(1), t { '', '}' } }),
  s('oncollisionstay', { t 'void OnCollisionStay(Collision collision) {', t { '', '    ' }, i(1), t { '', '}' } }),
